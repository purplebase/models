# purplebase/models — Agent Instructions

A Dart library providing Nostr event models, storage abstractions, and request handling for the purplebase ecosystem.
