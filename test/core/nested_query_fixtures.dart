...
class NestedQueryFixtures {
  ...
  void _createReleases() {
    ...
    release1v1 = partial1v1.dummySign(null, author1);
    ...
    release1v2 = partial1v2.dummySign(null, author1);
    ...
    release2v1 = partial2v1.dummySign(null, author2);
  }
  ...
  void _createNotes() {
    note1 = PartialNote('Hello from Alice!').dummySign(null, author1);
    note2 = PartialNote('Hello from Bob!').dummySign(null, author2);
    note3 = PartialNote('Hello from Charlie!').dummySign(null, author3);
  }
  ...
  void _createReplies() {
    ...
    reply1 = partial.dummySign(null, author2);
  }
